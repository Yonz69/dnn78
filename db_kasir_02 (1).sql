...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2024 at 01:25 AM
...
(1, 'tisu megic', 575, 15.00),
(3, 'bomm', 89, 4500.00),
(4, 'LL', 78, 25000.00),
(5, 'sabun colek', 30, 25000.00);
...
(17, '2024-02-27', 25030.00, 24057, 1);
...
--
ALTER TABLE `tb_detail_penjualan`
  MODIFY `id_detail_penjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
